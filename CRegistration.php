...
if(isset($_POST['creg-submit'])){ 
    ...
    if($password != $password2){
        ...
        $sql = "INSERT INTO counter(location,email,password) VALUES('$location','$email','$password')";
...
<div class="container">
    <h2 style="text-align:center;">Counter Registration</h2>
    <br>
    <form action="" method="post">
        <table style="margin-left:320px;">
            ...
            <tr>
                <td></td>
                <td><input type="submit" value="Submit" name="creg-submit"></td>
            </tr>
        </table>
    </form>
</div>
