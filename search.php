    ...
    <div>
        ...
        ?>
            ...
            <select name="from">
                ...
                <option value="<?php echo $row['cityF']; ?>" name="<?php echo $row['cityF']; ?>">
                    <?php echo $row['cityF']; ?></option>
                <?php endwhile; ?>
            </select>
            <?php 
            ...
            <select name="to">
                ...
                <option value="<?php echo $rows['cityT']; ?>" name="<?php echo $rows['cityT']; ?>">
                    <?php echo $rows['cityT']; ?></option>
                <?php endwhile; ?>
            </select>
            ...
            <br><br>
            <input type="submit" name="submit" value="SEARCH BUS">
        </form>
    </div>
</div>
