...
<?php 
    ...
    $logValid = "";
        ...
        if($email=='admin@abdulmabud.com' && $password=='admin@123'){
        ...
        // counter
        $sql = "SELECT * FROM counter WHERE email = '$email' and password = '$password' ";  
        $result = mysqli_query($db, $sql);
        while($row = mysqli_fetch_assoc($result)){  
            if($password == $row['password']){  
            echo "You are logged";
...
<div class="container">
    ...
    <form action="login.php" method="post">
        <table style="margin-left:320px;">
            ...
            <tr>
                <td></td>
                <td><label style="font-size:100%;">Don't have an account<a href="registration.php"
                            style="margin-left:10px;">Create Account</a></label></td>
            </tr>
        </table>
    </form>
</div>
