...
<?php 
    if(isset($_POST['cancel-submit'])){
        ...
        header("Location: cancelconfirm.php");
    }
?>
        ...
        <form action="" method="post">
            <table class="table">
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" style="display:none" ; value="<?php echo $row['id']; ?>" name="idVal">
                        <input type="text" style="display:none" ; value="<?php echo $row['busTime']; ?>" name="bTime">
                        <input type="submit" class="btn btn-success" name="cancel-submit" value="Cancel Ticket">
                    </td>
                    <?php  $noBus = ""; ?>
